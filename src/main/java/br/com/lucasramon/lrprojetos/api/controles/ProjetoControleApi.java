...
import br.com.lucasramon.lrprojetos.servicos.ProjetoServico;
...
public class ProjetoControleApi {
    ...
    public CollectionModel<EntityModel<Funcionario>> atualizarEquipe (@PathVariable Long id,@RequestBody @Valid EquipeDTO equipeDT0){
        List<Funcionario> equipe = projetoServico.atualizarEquipe(equipeDT0,id);
        return funcionarioAssembler.toCollectionModel(equipe);
